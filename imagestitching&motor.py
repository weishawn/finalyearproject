...
def motor_calibration(cell_seperation, frame_to_center_of_first_cell):
    ...
    one_step_moved = 200 / 3.142
    motor_step = math.floor(cell_seperation / one_step_moved)
    homing_distance = frame_to_center_of_first_cell + 5
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cell_seperation = int(input("Enter a number:"))
        frame_to_center_of_first_cell = int(input("Enter a number:"))
        motor_calibration(cell_seperation, frame_to_center_of_first_cell)
