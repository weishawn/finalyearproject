...
def motor(cell_seperation, frame_to_center_of_first_cell):
    #1 rotation is 200 step. translates to 3.142cm of horizontal movement.
    #to get the distance moved by motor
    one_step_moved = 3.142 / 200
    motor_step = int(math.floor(cell_seperation / one_step_moved))
    homing_distance = frame_to_center_of_first_cell - 3.5
    homing_step = int(math.floor(homing_distance / one_step_moved))
    print("translates to " + str(motor_step) +
          " steps to go from cell 1 to cell 2")
    print("After hitting limit switch motor moves " + str(homing_step) +
          " steps to first cell")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # cell_seperation = float(input("Enter cell seperation in cm:"))
        # frame_to_center_of_first_cell = float(
        # input("Enter frame to first cell seperation in cm:"))
        # motor_step, homing_step = motor(cell_seperation,
        # frame_to_center_of_first_cell)
        # print("translates to "+ str(motor_step) + " steps to go from cell 1 to cell 2")
        # print("After hitting limit switch motor moves " + str(homing_step) +" steps to first cell")
